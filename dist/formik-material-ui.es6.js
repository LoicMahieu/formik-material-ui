...
var fieldToTextField = function (_a) {
    var field = _a.field, form = _a.form, variant = _a.variant, _b = _a.disabled, disabled = _b === void 0 ? false : _b, error = _a.error, props = __rest(_a, ["field", "form", "variant", "disabled", "error"]);
    var name = field.name;
    ...
    return __assign({}, props, field, { variant: variant, error: showError || error, helperText: showError ? fieldError : props.helperText, disabled: isSubmitting || disabled });
};
